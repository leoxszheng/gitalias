...
alias gcp!='echo "git cherry-pick (upstream-commitid..commitid]"'
...
alias gdfisca='git diff --ignore-all-space --cached'
...
alias grb!='echo "git rebase --onto newbase (upstream branch]"'
